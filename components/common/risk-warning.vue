<template>
    <PDialog title="Risk Warning" @close="closeDialog">
        <div class="risk-wraning">
            ...
            <p>PAYASO V1.0 is currently a beta version, but the assets of ERC-20 used are real assets . V1.0 version contract were audit performed by KNOWNSEC and tested by community , but there' s still a risk of unintended use. Please communicate with community in discord #official channel if you encounter unintended product issues! </p>
