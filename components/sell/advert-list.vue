  ...
  <div class="advert-list">
    ...
    <div class="table-list-box">
      <table class="table">
        ...
        <tbody>
          <tr v-for="(item, index) in advertList" :key="index">
            ...
            <td>
              <button
                v-if="item.status === 'Being borrowed'"
      ...
      >
        ...
        <div class="tabs-item-box-btn" v-if="item.status === 'Being borrowed'">
          <!-- <p><a class="active" @click="toActive(item)">激活</a></p> -->
          <p>
            <button
              v-if="item.status === 'Being borrowed'"
              :class="currentCancelId === index ? 'button-loading' : ''"
  ...
  methods: {
    ...
    async setAdvertList(list) {
      ...
      for (let i = 0; i < list.length; i++) {
        ...
        if (askRes === "0") {
          resultItem["status"] = "Sell out";
          resultItem["sort"] = 1;
        } else {
          resultItem["status"] = "Being borrowed";
          resultItem["sort"] = 2;
        }
