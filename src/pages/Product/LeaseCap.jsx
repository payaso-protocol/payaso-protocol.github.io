...
export class LeaseCap extends Component {
  ...
  checkBalance = (val) => {
    ...
    let pay = (parseFloat(price) / parseFloat(_strikePrice)) * (val || 0);
    console.log(balance, pay);
          ...
          <div className="input_box">
            ...
            <div>
              <input
                ...
                onChange={(e) => {
                  this.handelChangeInput(e, parseInt(volume) * _strikePrice);
                }}
              />
              <span>{t("t52")}</span>
            </div>
            <p>
              <span>{t("t69", { num: remain * _strikePrice })}</span>
              <span>
